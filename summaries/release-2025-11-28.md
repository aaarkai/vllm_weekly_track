# Weekly Release Report for vllm-project/vllm (2025-11-28)

This week merged 240 PRs from 124 contributors. Key areas: features 5, fixes 15, performance 19.

## Executive Summary

本周发布主要围绕核心功能增强与性能优化展开。GPU Model Runner V2 的引入提升了推理架构的灵活性，同时 LoRA 针对 MoE 模型的权重加载逻辑和 3D 结构进行了持续优化。新增对 HunyuanOCR 模型的支持，扩展了多模态处理能力。性能方面，重点优化了 Model Runner V2 的 CUDA 图捕获时间、MoE LoRA 加载效率，并在 CPU 上利用 Arm NEON 加速注意力计算。硬件适配新增 H200 的 fused MoE 配置和 XPU 模型支持。

错误修复覆盖多个关键领域，包括解决 TPU 推理路径、TeleChatForCausalLM 注册异常、RoPE 兼容性问题及多模态输入处理故障。性能提升措施包括默认禁用 DeepGEMM MoE 以优化高并行度场景，并实现 Eagle 推测解码以降低延迟。模型支持新增 OpenCUA-7B，并完善了多模型加载机制。破坏性变更涉及计划移除 `override_pooler_config` 和 `disable_log_requests` 等接口，建议用户在升级前评估兼容性影响。
...
* Bump actions/checkout from 4 to 6 ([#29293](https://github.com/vllm-project/vllm/pull/29293)) by @dependabot
...
- This ensures backward compatibility during the deprecation period and provides a smoother migration path for users still using the deprecated `--task` parameter.
- upgrade torch & ipex 2.9 on XPU platform
- - `@dependabot ignore this major version` will close this PR and stop Dependabot creating any more for this major version (unless you reopen the PR or upgrade to it yourself)
- - `@dependabot ignore this minor version` will close this PR and stop Dependabot creating any more for this minor version (unless you reopen the PR or upgrade to it yourself)
- - `@dependabot ignore this dependency` will close this PR and stop Dependabot creating any more for this dependency (unless you reopen the PR or upgrade to it yourself)
- Hi ! With the recent refactoring of rope_parameters #https://github.com/vllm-project/vllm/pull/28542 it introduced a breaking change for Mistral configs using yarn.

## Contributors

@Adityayxt, @ApostaC, @Aydin-ab, @BoyuanFeng, @DarkLight1337, @Flechman, @FlintyLemming, @GOavi101, @HDCharles, @Inokinoki, @Isotr0py, @Jialin, @Livinfly, @LucasWilkinson, @MatthewBonanni, @NickLucche, @R3hankhan123, @RobMulla, @Victor49152, @WoosukKwon, @Yejing-Lai, @ZJY0516, @alec-flowers, @alex-jw-brooks, @andyxning, @angelayi, @apinge, @askliar, @bbartels, @bbrowning, @bhagyashrigai, @bigPYJ1151, @bnellnm, @bwasti, @charlifu, @coval3nte, @david6666666, @dependabot, @didier-durand, @divakar-amd, @eldarkurtic, @elvischenv, @faaany, @fadara01, @fsx950223, @ganyi1996ppo, @gbyu-amd, @gcanlin, @geodavic, @gmagogsfm, @guodongxiaren, @halyavin, @hasB4K, @heheda12345, @hjh0119, @hjjq, @hl475, @hmellor, @hongxiayang, @huachenheli, @ilmarkov, @ivanium, @izhuhaoran, @janeyx99, @jcyang43, @jeejeelee, @jeremyteboul, @jiahanc, @jikunshang, @jinzhen-lin, @joshiemoore, @juliendenize, @kflu, @laithsakka, @lengrongfu, @lgeiger, @lim4349, @louie-tsai, @luccafong, @maang-h, @madskildegaard, @maleksan85, @markmc, @maryamtahhan, @mgoin, @micah-wil, @michaelact, @morrison-turnansky, @nandan2003, @njhill, @noooop, @princepride, @qandrew, @qli88, @rasmith, @rjrock, @russellb, @scydas, @sfbemerk, @skaraban3807, @skyloevil, @soodoshll, @sts07142, @tdoublep, @terrytangyuan, @tjtanaa, @tlrmchlsmth, @varun-sundar-rabindranath, @vllmellm, @wangxiyuan, @wilsonwu, @wxsIcey, @xieyangxu, @xli, @xuechendi, @xyang16, @yewentao256, @yihong0618, @yiz-liu, @yma11, @yongming-qin, @ywang96, @zhxchen17, @zhyajie